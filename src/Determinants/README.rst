...
`davidson_converged <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L510>`_
  True if the Davidson algorithm is converged


`davidson_criterion <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L500>`_
...
`davidson_diag_hjj <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L186>`_
...
`davidson_threshold <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L501>`_
  Can be : [  energy  | residual | both | wall_time | cpu_time | iterations ]
...
`sort_dets_ab <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L142>`_
  Undocumented


`sort_dets_ba <http://github.com/LCPQ/quantum_package/tree/master/src/Determinants/davidson.irp.f#L123>`_
  Undocumented
